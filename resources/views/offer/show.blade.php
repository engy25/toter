...
<div class="row justify-content-center">
  ...
  <div class="col-xl-10 col-md-10 col-14 mb-md-0 mb-6">
    <div class="card invoice-preview-card">
        ...
        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
          ...
          <div style="max-width:20 ">
            ...
            {{-- <div class="pt-1">
              ...
              <span class="fw-semibold">{{ $store->delivery_fees}} {{ $store->defaultCurrency->isocode }}</span>
            </div> --}}
          </div>
        </div>
      </div>
        ...
        <div class="row p-sm-3 p-0">
          <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
            ...
            <h6>
              ...
              $store->pointstore->order_counts . " orders." ."and the minimum price of the total of orders is ".$store->pointstore->min_price ." this points  must make  in ".$store->pointstore->expire_days." days" }}
            </h6>
      ...
      <h5 class="my-3 text-center">Week Hours</h5>
      ...
      <br><br>
      <h5 class="my-3 text-center">Districts</h5>
      <div class="table-responsive border-top">
        <table class="table m-0">
          <thead>
            <tr>
      ...
      <br><br>
      <h5 class="my-3 text-center">Tags</h5>
      <div class="table-responsive border-top">
        <table class="table m-0">
          <thead>
            <tr>
