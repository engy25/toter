      ...
      <table id="data-table2" class="table border p-0 text-nowrap mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="{{ asset($offer->image) }}" alt="offer Image" style="height: 50% ; width:50%"
                class="img-fluid"></td>
            ...
            <td class="center align-middle">
              <div class="btn-group">
                ...
                <a href="{{ LaravelLocalization::localizeURL(route('offers.edit', $offer->id)) }}"
                  class="btn btn-info btn-icon py-1 me-2" title="Edit" style="width: 100px; height: 40px;">
                  {{ trans('words.edit') }} <i class="bi bi-pencil-square fs-16"></i>
                </a>
                <a href="{{ route('offers.show', $offer->id) }}" class="btn btn-success show-offer"
                  style="width: 100px; height: 40px;">
                  <i class="bi bi-eye"></i> {{ trans('words.show') }}
                </a>&nbsp;&nbsp;
                <button type="button" class="btn btn-danger delete-offer" data-id="{{ $offer->id }}"
                  style="width: 100px; height: 40px;">
