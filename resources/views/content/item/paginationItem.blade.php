    ...
    @forelse($items as $item)
      <tr>
        ...
        <td class="center align-middle">
          <div class="btn-group">
            <a href="{{ route('items.edit', $item->id) }}" class="btn bg-info-transparent d-flex align-items-center justify-content-center">
              <i style="font-size: 20px;" class="fe fe-edit text-info "></i>
            </a>

            <a href="{{ LaravelLocalization::localizeURL(route('items.edit', $item->id)) }}" class="btn btn-info btn-icon py-1 me-2"
               data-id="{{ $item->id }}"
