    ...
    <div class="card-body">
        <div class="row p-sm-3 p-0">
            <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                ...
                <h5 class="mb-1">Callcenter First Name:</h5>
                <h6 class="mb-3">{{ $order->callcenter->fname }}</h6>
                <h5 class="mb-1">Callcenter Phone:</h5>
                <h6 class="mb-3">{{ $order->callcenter->phone }}</h6>
                ...
                <h6 class="mb-3">{{ optional($order->address)->title }}</h6>
                <h5 class="mb-1">Building:</h5>
                <h6 class="mb-3">{{ optional($order->address)->building }}</h6>
                <h5 class="mb-1">Street:</h5>
                <h6 class="mb-3">{{ optional($order->address)->street }}</h6>
                <h5 class="mb-1">Apartment:</h5>
                <h6 class="mb-3">{{ optional($order->address)->apartment }}</h6>
                <h5 class="mb-1">Instructions:</h5>
                <h6 class="mb-3">{{ optional($order->address)->instructions }}</h6>
