...
<!-- Modal -->
<div class="modal fade" id="updatePermissionModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="updateModalLabel">Update Permission</h1>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary update_permission">Update changes</button>
        </div>
      </div>
    </div>
  </form>
