...
<!-- Modal -->
<div class="modal fade" id="updateScheduleModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
  <form action="" method="POST" id="update_schedule_form">
    @csrf
...
<br>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary update_schedule">Update changes</button>
        </div>
      </div>
    </div>
  </form>
