...
<script>
  ...
  let roleName = window.location.pathname.split('/').pop();
  console.log(roleName);
  user(page, roleName);

});

function user(page,roleName) {
    $.ajax({
      url: "/pagination/paginate-user/" + roleName + "?page=" + page, // Updated URL
        type: 'get',
        success: function(data) {
