      ...
      <tr>
        ...
        <td class="center align-middle">
          <div class="btn-group">
            ...
            <a href="{{ LaravelLocalization::localizeURL(route('users.edit', $user->id)) }}" class="btn btn-info btn-icon py-1 me-2" data-id="{{ $user->id }}" title="Edit" style="width: 100px; height: 40px;">
                {{ trans('words.edit') }} <i class="bi bi-pencil-square fs-16"></i>
            </a>
            <a href="{{ route('users.show', $user->id) }}" class="btn btn-success show-delivery" style="width: 100px; height: 40px;">
