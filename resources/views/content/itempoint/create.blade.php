...
<div class="card">
  ...
  <div class="card-body">
    ...
    @endif
    <form method="post" action="{{ route('itempoints.store') }}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="mb-3">
        ...
        <span class="text-danger error-message" id="error_point"></span>
      </div>
...
@include('content.itempoint.itempoint_js')
@endsection
