...
<script>
  $(document).ready(function(){
    ...
    $.ajax({
      ...
      url: "{{ route('itempointsizes.store') }}",
      method: 'post',
      data: formData,
      dataType: "json",
      ...
      $('#addSizeForm')[0].reset();
      $('#table-size').load(location.href+' #table-size');
      $('#sizeadd').show();
  ...
  $('.errMsgContainer').empty(); // Clear previous error messages
    ...
    if (confirm("Are you sure you want to delete this Size?")) {
        $.ajax({
            ...
            error: function (data) {
              alert('Deletion of this Size is forbidden as it is related to other tables.');
                console.log(data);
