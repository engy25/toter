...
<div class="d-flex justify-content-between align-items-center">
  ...
  <div class="d-flex align-items-center">
    ...
    <a href="{{ route('restaurantusers.create') }}" class="btn btn-primary me-2" title="{{ trans('words.add') }}">
      {{ trans('words.add') }}
    </a>
...
<div class="card">
  <div class="card-body">
    <div class="table-responsive">
      ...
      @include('content.restaurantUser.pagination_index')

    </div>
  </div>
</div>

@include('content.restaurantUser.user_js')
