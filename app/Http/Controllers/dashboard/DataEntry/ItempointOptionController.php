...
use App\Http\Requests\dash\DE\OptionItemPointRequest;


class ItempointOptionController extends Controller
{
   ...
   */
  public function store(OptionItemPointRequest  $request)
  {
