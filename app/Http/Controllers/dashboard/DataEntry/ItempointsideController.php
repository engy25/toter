...
use App\Http\Requests\dash\DE\{SidepointStoreRequest};
use App\Helpers\Helpers;
class ItempointsideController extends Controller
{
  public $helper;
   ...
   */
  public function store(SidepointStoreRequest $request)
  {
