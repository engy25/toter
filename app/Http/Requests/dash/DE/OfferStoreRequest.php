...
class OfferStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
          ...
          'order_counts' => 'numeric|integer|required|digits_between:1,11',
          'required_points'=>'numeric|integer|required|digits_between:1,30',
          'earned_points'=>'numeric|integer|required|digits_between:1,30',
         'featured'=>'nullable'
